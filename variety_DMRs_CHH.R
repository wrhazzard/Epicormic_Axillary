...
DMRsvariety_CHH_all<- c(DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, DMRsGenesCG)


DMRsvariety_CHH_all_df<- as.data.frame(DMRsvariety_CHH_all)


save(DMRsGenesCG, DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, file = "/users/PAS1755/whazzard/DMRCHHs_variety.RData")
