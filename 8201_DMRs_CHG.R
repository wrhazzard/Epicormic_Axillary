...
seqlevels(almond.gff)<- sub("CM038036.2", "mit", seqlevels(almond.gff))
...
DMRs8201CHG_all<- c(DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, DMRsGenesCG)


DMRs8201CHG_all_df<- as.data.frame(DMRs8201CHG_all)

write.csv(unlist(DMRs8201CHG_all_df), "/users/PAS1755/whazzard//DMRCHG201_annotation.csv")

save(DMRsGenesCG, DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, DMRsGenesCGmit, file = "/users/PAS1755/whazzard/DMRCHG201_annotation.RData")
