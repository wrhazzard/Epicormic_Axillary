...
DMRsGenesCG1<-filterDMRs(variety_list[["8_160"]],
                   variety_list[["8_201"]],
...
DMRsGenesCG2<-filterDMRs(variety_list[["8_160"]],
                   variety_list[["8_201"]],
...
DMRsGenesCG3<-filterDMRs(variety_list[["8_160"]],
                   variety_list[["8_201"]],
...
DMRsGenesCG4<-filterDMRs(variety_list[["8_160"]],
                   variety_list[["8_201"]],
...
DMRsGenesCG5<-filterDMRs(variety_list[["8_160"]],
                   variety_list[["8_201"]],
...
DMRsGenesCG6<-filterDMRs(variety_list[["8_160"]],
                   variety_list[["8_201"]],
...
DMRsGenesCG7<-filterDMRs(variety_list[["8_160"]],
                   variety_list[["8_201"]],
...
DMRsGenesCG<-filterDMRs(variety_list[["8_160"]],
                   variety_list[["8_201"]],
...
DMRsvariety_CHG_all<- c(DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, DMRsGenesCG)


DMRsvariety_CHG_all_df<- as.data.frame(DMRsvariety_CHG_all)


save(DMRsGenesCG, DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, file = "/users/PAS1755/whazzard/DMRCHGs_variety.RData")
