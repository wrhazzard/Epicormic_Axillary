...
DMRs8160Cg_all<- c(DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, DMRsGenesCG)


DMRs8160Cg_all_df<- as.data.frame(DMRs8160Cg_all)

write.csv(unlist(DMRs8160Cg_all_df), "/fs/scratch/PAS1755/Will/EpiAxi/Visualization/In_DMRcaller/context_report/DMR_CpG_annotation.csv")

save(DMRsGenesCG, DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, file = "/users/PAS1755/whazzard/DMRCGs_annotation.RData")
