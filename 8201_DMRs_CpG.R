...
DMRs8201Cg_all<- c(DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, DMRsGenesCG)


DMRs8201Cg_all_df<- as.data.frame(DMRs8201Cg_all)

write.csv(unlist(DMRs8201Cg_all_df), "/users/PAS1755/whazzard//DMRCGs201_annotation.csv")

save(DMRsGenesCG, DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, file = "/users/PAS1755/whazzard/DMRCGs201_annotation.RData")
