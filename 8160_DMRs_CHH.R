...
DMRs8160CHH_all<- c(DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, DMRsGenesCG)


DMRs8160CHH_all_df<- as.data.frame(DMRs8160CHH_all)

write.csv(unlist(DMRs8160CHH_all_df), "/users/PAS1755/whazzard/DMRCHH_annotation.csv")

save(DMRsGenesCG, DMRsGenesCG1, DMRsGenesCG2, DMRsGenesCG3, DMRsGenesCG4, DMRsGenesCG5, DMRsGenesCG6, DMRsGenesCG7, file = "/users/PAS1755/whazzard/DMRCHH_annotation.RData")
